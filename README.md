...
[![codecov](https://codecov.io/gh/firemanxbr/fastapi-project/branch/main/graph/badge.svg?token=fastapi-project_token_here)](https://codecov.io/gh/firemanxbr/fastapi-project)
[![CI](https://github.com/firemanxbr/fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/firemanxbr/fastapi-project/actions/workflows/main.yml)

Awesome fastapi_project created by firemanxbr

## Install

from source
```bash
git clone https://github.com/firemanxbr/fastapi-project fastapi_project
cd fastapi_project
make install
```
